 ...
 * IMPORTANT: This function MUST be called within a Sequelize transaction.
 * @param user The user instance performing the action.
 * @param tokenAmount The amount of tokens to award.
 * @param t The Sequelize transaction object.
 */
